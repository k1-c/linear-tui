...
use crate::core::entity::Page;
use crate::core::message::Message;
use crate::core::usecase::{
    Request, agent, cycle, favorite, issue, notes, project, team, user, view,
};
...
async fn run_request(client: &LinearClient, req: &Request, per_page: u32) -> Result<Message> {
    ...
    match req {
        ...
        Request::Notes(notes::Request::Deliver(handoff)) => {
            crate::infra::herdr::deliver(handoff).await?;
...
mod tests {
    ...
    use super::*;
    use crate::core::entity::TeamId;
    use crate::infra::linear::client::StaticCredentials;

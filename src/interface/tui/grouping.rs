...
//! transformation, kept apart from [`crate::interface::tui::app`] so it can be exercised on
//! plain slices.
...
use crate::core::entity::{Issue, Priority, StateType};
use crate::interface::tui::look::{PriorityLook, StateLook, hex_color};
...
pub use crate::core::entity::Preset;
...
fn assignee_name(user: &crate::core::entity::User) -> String {
    user.display_name
        .clone()

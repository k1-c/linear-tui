...
commands — reading, commenting and replying, editing and deleting its own
comments, changing state, updating fields, filing — the rule that an issue is
only moved or edited when you ask, and that it can
